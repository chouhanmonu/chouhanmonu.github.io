export const PROJECTS = [
  ...
  },
  {
    ...
    role: {
      summary:
        "As a senior software engineer, I spearheaded the web and backend development to deliver a polished, production-ready core:",
      contributions: [
        {
  ...
  },
  {
    ...
    role: {
      summary:
        "As a senior software engineer on the turnaround team, I collaborated daily with clients to triage issues and roadmap enhancements, transforming a buggy prototype into a robust MVP:",
      contributions: [
        {
